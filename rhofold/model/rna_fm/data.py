...
class Alphabet(object):
    ...
    def from_architecture(cls, name: str, theme="protein") -> "Alphabet":
        if name in ("ESM-1", "protein_bert_base"):
            ...
            append_eos = False
            use_msa = False
        elif name in ("ESM-1b", "roberta_large"):  # it is employed
            standard_toks = proteinseq_toks["toks"] if theme == "protein" else rnaseq_toks["toks"]
...
class BatchConverter(object):
    ...
    def __call__(self, raw_batch: Sequence[Tuple[str, str]]):
        ...
        """
        labels:['query', 'URS0000CDE670_54_120_f/24-46']
        strs:['CCGCCGCGCCAUGCCUGUGGCGG', 'CCGCCGCGCCAUGCCUGUGGCCG']
        tokens: tensor([[0, 7, 7, 6, 7, 7, 6, 7, 6, 7, 7, 4, 5, 6, 7, 7, 5, 6, 5, 6, 6, 7, 6, 6],[0, 7, 7, 6, 7, 7, 6, 7, 6, 7, 7, 4, 5, 6, 7, 7, 5, 6, 5, 6, 6, 7, 7, 6]]):

        labels:['3meiA']
        strs:[Seq('CCGCCGCGCCAUGCCUGUGGCGG')]
        tokens: tensor([[0, 5, 5, 6, 5, 5, 6, 5, 6, 5, 5, 4, 7, 6, 5, 5, 7, 6, 7, 6, 6, 5, 6, 6, 2]])
        """
...
class MSABatchConverter(BatchConverter):
    def __call__(self, inputs: Union[Sequence[RawMSA], RawMSA]):
        ...
        #print('MSA labels:{}'.format(labels))
        #print('MSA strs:{}'.format(strs))
        #print('MSA tokens: {}'.format(tokens))
...
def get_rna_fm_token(pdb_id, sequence,
    ...
    data = [[ pdb_id, Seq(sequence)]] ###[['3meiA', Seq('CCGCCGCGCCAUGCCUGUGGCGG')]]
